...
/*== STEP 1 ===============================================================
The section below creates a Demo database table with a "content" field. Try
adding a new "isDone" field as a boolean. The authorization rule below
specifies that any user authenticated via an API key can "create", "read",
"update", and "delete" any "Demo" records.
=========================================================================*/
...
// const { data: Demos } = await client.models.Demo.list()

// return <ul>{Demos.map(Demo => <li key={Demo.id}>{Demo.content}</li>)}</ul>